...
$sql_borrowings = "SELECT COUNT(*) as count FROM borrowings WHERE user_id = ? AND returned = 0";
...
$sql_due = "SELECT COUNT(*) as overdue FROM borrowings WHERE user_id = ? AND returned = 0 AND DATE_ADD(borrow_date, INTERVAL 15 DAY) < NOW()";
